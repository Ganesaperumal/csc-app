...
files.forEach(file => {
  ...
  content = content.replace(/background: 'linear-gradient\(135deg, rgba\(255, 255, 255, 0\.9\), rgba\(255, 255, 255, 0\.7\)\)'/g, "background: 'var(--surface-color)'");
  content = content.replace(/background: 'linear-gradient\(135deg, rgba\(248, 250, 252, 0\.95\), rgba\(241, 245, 249, 0\.95\)\)'/g, "background: 'var(--surface-color)'");
