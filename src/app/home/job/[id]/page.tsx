                                  ...
                                  {['TI', 'HYBRID', 'PIKKOL'].map((option) => (
                                    <label key={option} style={{ width: 'auto', display: 'flex', alignItems: 'center', gap: '0.4rem', textTransform: 'none', fontSize: '0.9rem', color: 'var(--text-primary)', cursor: isViewer ? 'not-allowed' : 'pointer', fontWeight: 400 }}>
                                      <input 
                                        ...
                                        name="sales_by" 
                                        value={option} 
                                        checked={job.sales_by === option} 
                                        onChange={() => handleFieldChange('sales_by', option)} 
                                        style={{ width: '16px', height: '16px', margin: 0, cursor: isViewer ? 'not-allowed' : 'pointer', accentColor: '#4f46e5' }} 
                                      /> 
                                      {option}
                                    </label>
                                  ))}
            ...
            {GOODS_TRACK_OPTIONS.map((option, idx) => {
              ...
              return (
                <div 
                  ...
                  onClick={() => { if (!isViewer) handleFieldChange('goods_track_status', option); }}
